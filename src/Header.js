            ...
            <Row>
                <Col lg>
                    <div className='introduction'>
                        ...
                        <Link className='introduction-projects-button' activeClass="active" to="projects" spy={true} smooth={true} offset={-25} duration={100}>
                            View Projects
                        </Link>
                        <Link className='introduction-contact-button' activeClass="active" to="contact" spy={true} smooth={true} offset={-25} duration={100}>
                            Contact Details
                        </Link>
                        </div>
                        <br/>
